...
function _chart(d3,data)
{
  ...
  const svg = d3.create("svg")
      .attr("viewBox", [-width / 2, -height / 2 + 200, width, width])
...
export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([
    ["flare-2.json", {url: new URL("./files/Motorcycle_Sales_2019.json", import.meta.url), mimeType: "application/json", toString}]
  ]);
